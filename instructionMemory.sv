...
initial begin
  ...
  RegisterA[22] = 32'b000000000000_00010_001_01011_0000011; // ,LH
  RegisterA[23] = 32'b000000000000_00001_010_01010_0000011; // ,LW
  RegisterA[24] = 32'b000000000000_00000_100_01001_0000011; // ,LBU
  RegisterA[25] = 32'b000000000000_00001_101_01000_0000011; // ,LHU
  
  
  RegisterA[26] = 32'b0000000_00000_00100_000_00001_0100011; //SB
  RegisterA[27] = 32'b0000000_00001_00101_001_00010_0100011; //SH
  ...
  /**
  //B test
  RegisterA[20] = 32'b0000000_00000_00010_000_11111_1100011; // BEQ: if (reg0 == reg4) branch
  RegisterA[21] = 32'b0100000_00111_00011_000_11110_1100011; // BNE: if (reg7 != reg3) branch
  RegisterA[22] = 32'b0000000_00111_00000_001_11101_1100011; // BLT: if (reg7 < reg0) branch
  RegisterA[23] = 32'b0000000_00000_00100_010_11100_1100011; // BGE: if (reg0 >= reg4) branch
  RegisterA[24] = 32'b0000000_00001_00000_011_11011_1100011; // BLTU: if (reg1 <u reg0) branch
  RegisterA[25] = 32'b0000000_10100_11001_100_11010_1100011; // BGEU: if (reg20 >=u reg25) branch
  **/
  /**
